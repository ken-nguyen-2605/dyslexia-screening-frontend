...
import type { PlanetTheme } from '../components/visuals/PlanetBackground';
import type { MascotEmotion } from '../components/visuals/Mascot';

// Import Services (Hậu cần & Cấu hình)
import { checkHandwritingAI } from '../services/mockAI';
import { 
  GAME_CONFIG, 
  LETTERS_POOL, 
  PRAISE_MESSAGES, 
...
export const useGameLogic = () => {
  ...
  const handleSubmitAnswer = useCallback(async (imageBase64: string) => {
