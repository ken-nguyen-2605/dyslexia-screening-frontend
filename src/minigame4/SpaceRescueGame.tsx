...
import Spaceship from './components/visuals/SpaceShip';
import Mascot from './components/visuals/Mascot';
import EffectLayer from './components/visuals/EffectLayer';

// 3. IMPORT HUD
import GameHeader from './components/HUD/GameHeader';

// 4. IMPORT PLAY AREA
import DrawingPad from './components/playArea/DrawingPad';
