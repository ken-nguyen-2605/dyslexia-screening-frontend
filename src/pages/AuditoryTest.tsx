...
import TestDifficultyRating from "../components/TestDifficultyRating";
import AuditoryTestInstruction from "../components/AuditoryTestInstruction";
import AuditorySoundOptionChoice, {
	type AuditorySoundOptionChoiceQuestion,
} from "../components/AuditorySoundOptionChoice";
...
const AUDITORY_TEST_STEPS = ["INSTRUCTION", "QUESTION", "RATING"];
...
const AuditoryTestLayout = () => {
	...
	const goToNextQuestion = () => {
		...
		if (currentQuestionIndex === QUESTIONS_INFO.length - 1) {
			// Last question, go to rating step
	...
	let stepContent;
	switch (QUESTIONS_INFO[currentQuestionIndex].module) {
